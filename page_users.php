...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
    <a class="navbar-brand d-flex align-items-center fw-500" href="page_users.php"><img alt="logo"
...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <div class="row">
        <div class="col-xl-12">
            <?php echo ($_SESSION['status']) ? '<a class="btn btn-success" href="create_user.php">Добавить</a>' : '' ?>
    ...
    <div class="row" id="js-contacts">
        <?php $people = get_all_user(); ?>
        <?php foreach ($people as $person): ?>
            <div class="col-xl-4">
                <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover"
                     data-filter-tags="<?php echo $person['data_filter_tags']; ?>">
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block "
                                          style="background-image:url('<?php echo $person['image']; ?>'); background-size: cover;"></span>
                               </span>
                            <div class="info-card-text flex-1">
                                <?php echo $person['name']; ?>
                                <?php if ($_SESSION['status'] || $_SESSION['id'] == $person['id']): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="id=<?php echo $person['id']; ?>" class="dropdown-item"
                                ...
                                <?php endif; ?>
                                <span class="text-truncate text-truncate-xl"><?php echo $person['work_place']; ?></span>
                            </div>
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <address class="fs-sm fw-400 mt-4 text-muted">
                                <i class="fas fa-map-pin mr-2"></i> <?php echo $person['location']; ?></address>
